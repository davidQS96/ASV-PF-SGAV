...
#Creacion de ventana --------------------------------------------------------------------------------
    ...
    while running:
        ...
        for line in circuit.getLines():
            ...
            screen.blit(text_surface, (780, 40))

            #Texto de velocidad del carro
            text_surface2, rect2 = gameFont.render("Veloc: " + str(car.speed), textColor)
            screen.blit(text_surface2, (780, 70))
...
def interfaz():
    ...
    gdaR = tk.Radiobutton(f2, text = "Gira a la derecha y acelera", variable = status.intVarCmd, value = 1, command = transmitMessage)
    giaR = tk.Radiobutton(f2, text = "Gira a la izquierda y acelera", variable = status.intVarCmd, value = 2, command = transmitMessage)
    gddR = tk.Radiobutton(f2, text = "Gira a la derecha y desacelera", variable = status.intVarCmd, value = 3, command = transmitMessage)
    gidR = tk.Radiobutton(f2, text = "Gira a la izquierda y desacelera", variable = status.intVarCmd, value = 4, command = transmitMessage)
...
if __name__ == "__main__":
    ...
    th.Thread(target = interfaz).start()
